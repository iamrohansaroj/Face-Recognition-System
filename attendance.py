...
class Attendance:
        def __init__(self,root):
                ...
                # second image
                img1=Image.open(r"college_images\learning.jpg")
                ...
                img3=img3.resize((1270,520),Image.ANTIALIAS)
                self.photoimg3=ImageTk.PhotoImage(img3)

                bg_img=Label(self.root,image=self.photoimg3)
                bg_img.place(x=0,y=200,width=1270,height=520)
                ...
                left_inside_frame.place(x=0,y=100,width=630,height=260)
                ...
                btn_frame.place(x=0,y=220,width=620,height=30)
