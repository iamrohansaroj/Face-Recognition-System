...
class Face_Recognition:
    def __init__(self,root):
        ...
        img_top=img_top.resize((560,600),Image.ANTIALIAS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=50,width=560,height=600)
        ...
        img_bottom=img_bottom.resize((880,600),Image.ANTIALIAS)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        f_lbl=Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=500,y=50,width=880,height=600)
        ...
        b1_1.place(x=350,y=525,width=190,height=35)
