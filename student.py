...
class Student:
    def __init__(self,root):
        ...
        # third image
        img2=Image.open(r"college_images\learning.jpg")
        ...
        main_frame.place(x=3,y=45,width=1260,height=600)

        # left label frame

        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=640,height=450)
        ...
        f_lbl.place(x=5,y=0,width=625,height=100)
        ...
        class_Student_frame.place(x=5,y=200,width=630,height=230)
        ...
        btn_frame.place(x=0,y=175,width=620,height=30)
        ...
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Photo Sample",width=15,font=("times new roman",12,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=4)

        update_photo_btn=Button(btn_frame,text="Update Photo Sample",width=15,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        Search_frame.place(x=5,y=100,width=570,height=60)

        search_label=Label(Search_frame,text="Phone No:",font=("Search By:",15,"bold"),bg="red",fg="white")
        ...
        table_frame.place(x=5,y=170,width=580,height=257)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Roh@n123",database="face_recognizer")
